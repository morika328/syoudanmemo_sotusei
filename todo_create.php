...
$sql = 'INSERT INTO memo_table(id, user_id,customer_name, interest, Dr, DH, other, maker, how_long, problem, point, created_at, updated_at) VALUES(NULL, :user_id, :customer_name, :interest, :Dr, :DH, :other, :maker,  :how_long, :problem, :point,sysdate(), sysdate())';
